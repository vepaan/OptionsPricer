...
The Monte-Carlo simulations are run in **C++** to increase siumlation efficiency and decrease runtime, and the C++ file is linked to python via **pybind11**, where the C++ file acts as an external library.
